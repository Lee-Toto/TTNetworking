...
extension UIColor {
    ...
    convenience init(_ hexString:String, _ alpha: CGFloat = 1.0) {
        ...
        self.init(red:CGFloat((valueRGB & 0xFF0000)>>16)/255.0, green:CGFloat((valueRGB & 0x00FF00)>>8)/255.0, blue:CGFloat(valueRGB & 0x0000FF)/255.0, alpha:CGFloat(alpha)
        )
    }
...
extension UIColor {
    ...
    static let black_30 = UIColor("2A2B30")
        
    static let white_ff = UIColor("FFFFFF")
    
    static let white_10 = UIColor("FFFFFF",0.1)
    
    static let white_30 = UIColor("FFFFFF",0.3)
    
    static let red_1b = UIColor("F6281B")
    
    static let green_2a = UIColor("00B42A")
